              ...
              <div class="rd-navbar-main-bottom rd-navbar-darker">
                <div class="rd-navbar-main-container container">
                  ...
                  <ul class="rd-navbar-nav"> 
                    ...
                    <li class="rd-nav-item d-lg-block d-lg-none d-xl-block d-xl-none" ><a class="rd-nav-link" href="/{{\Carbon\Carbon::now()->addDay(1)->locale('pt_BR')->format('Y-m-d')}}">Jogos do dia {{\Carbon\Carbon::now()->addDay(1)->locale('pt_BR')->format('d/m/Y')}}</a></li>
                    <li class="rd-nav-item d-lg-block d-lg-none d-xl-block d-xl-none"><a class="rd-nav-link" href="/{{\Carbon\Carbon::now()->addDay(2)->locale('pt_BR')->format('Y-m-d')}}">Jogos do dia {{\Carbon\Carbon::now()->addDay(2)->locale('pt_BR')->format('d/m/Y')}}</a></li>
                    <li class="rd-nav-item d-lg-block d-lg-none d-xl-block d-xl-none"><a class="rd-nav-link" href="/{{\Carbon\Carbon::now()->addDay(3)->locale('pt_BR')->format('Y-m-d')}}">Jogos do dia {{\Carbon\Carbon::now()->addDay(3)->locale('pt_BR')->format('d/m/Y')}}</a></li>
