            ...
            <div class="main-content horizontal-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="breadcrumb-header justify-content-between">
                        <div class="my-auto">
                            <div class="d-flex">
                                <h4 class="content-title mb-0 my-auto">Esportes</h4>
                                <span class="text-muted mt-1 tx-13 ml-2 mb-0">/ {{ $esporte->nome_traduzido }}</span>
                            </div>
                        </div>
                    </div>
                    <!-- breadcrumb -->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header bg-red">
                                    <h5 class="card-title">{{ $esporte->nome_traduzido }}</h5>
