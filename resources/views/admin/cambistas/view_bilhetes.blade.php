...
<div class="main-content" id="panel">
    ...
    <div class="container-fluid">
        ...
        <div class="card card-stats">
            ...
            <div class="row">
                <div class="col">
                <h5 class="card-title text-uppercase text-muted mb-0">Entradas Pendente</h5>
        ...
        <div class="card card-stats">
            ...
            <div class="row">
                <div class="col">
                <h5 class="card-title text-uppercase text-muted mb-0">Lançamento</h5>
        ...
        <div class="card card-stats">
            ...
            <div class="row">
                ...
                <span class="h2 font-weight-bold mb-0" ">R$ {{number_format($total,2,',','.')}}</span>
                </div>
                <div class="col-auto">
                <div class="icon icon-shape bg-gradient-green text-white rounded-circle shadow">
                    <i class="ni ni-money-coins"></i>
