                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Gerênciamento de Risco</h4>
                            <span>Visualizar Gerênciamento de Risco nas Apostas</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Jogos</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Gerênciamrnto de Risco</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
