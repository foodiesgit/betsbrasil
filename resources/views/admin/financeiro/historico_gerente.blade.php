                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Histórico Lançamentos Gerentes</h4>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card" style="height: auto;">
                            <div class="card-header d-block">
                                ...
                                <p class="mb-0 subtitle">Resumo da movimentação no período - {{ $datas['dataInicio'] }} a {{ $datas['dataFinal'] }}</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <table class="table table-border text-center">
                                            <tr>
                                                <td>
                                                    <b>Total em Comissões</b><br>
                                                    <span class="total_comissao">R$ 0,00</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                        ...
                        <div class="card" style="height: auto;">
                            ...
                            <div class="card-body">
                            {{ Form::model($datas, ['url' => ['admin/gerentes/caixa/historico', $usuario->id], 'id' => 'form1', 'method' => 'GET']) }}
                                <div class="row">
