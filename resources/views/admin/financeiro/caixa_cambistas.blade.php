                                                            ...
                                                            <td>
            													<div class="dropdown">
            														...
            														<div class="dropdown-menu">
            															<a class="dropdown-item" href="/admin/cambistas/caixa/lancamentos/'.$dados->idusuario.'">Realizar Lançamento</a>
                                                                        <a class="dropdown-item" href="/admin/cambistas/caixa/historico/'.$dados->idusuario.'">Histórico Financeiro</a>
            														</div>
            													</div>
            												</td>
                                                        </tr>
