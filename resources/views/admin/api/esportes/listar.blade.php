                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>API</h4>
                            <span>Listar Esportes</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">API</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Esportes</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                                            ...
                                                            <td>
            													<div class="dropdown">
            														...
            														<div class="dropdown-menu">
            															<a class="dropdown-item" href="/admin/api/esportes/editar/'.$dados->id.'">Editar</a>
