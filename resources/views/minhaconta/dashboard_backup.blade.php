                            ...
                            <div class="card-body">
                                ...
                                <!-- <div class="row">
                                    <div class="form-group col-md-6 col-sm-12">
                                        ...
                                        {{ Form::text('filtro_inicio', null, ['id' => 'filtro_inicio', 'class' => 'form-control form-control-lg '.( $errors->has('filtro_inicio') ? ' is-invalid' : '' ), 'placeholder' => 'Digite uma data inicial para filtrar']) }}
                                        @error('filtro_inicio')<div class="invalid-feedback animated fadeInUp">{{ $message }}</div>@enderror
                                    </div>
                                </div> -->
                							...
                							<div class="card-body p-4">
                								<div class="media">
                									...
                									<div class="media-body text-white text-right">
                										<p class="mb-1">Ganhos no Período</p>
                										<h3 class="text-white">R$ 0,00</h3>
                									</div>
                								</div>
                							</div>
                						</div>
