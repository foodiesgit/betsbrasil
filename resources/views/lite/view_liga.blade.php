...
<body>
  ...
  <input type="hidden" name="idliga" value="{{ $liga->id }}">
...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        var idliga = $('input[name=idliga]').val();
        $.ajax({
            url: '/ajax/recupera-jogos-liga/'+idliga,
            method: 'GET',
