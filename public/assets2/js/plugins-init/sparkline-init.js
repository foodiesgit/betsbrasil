...
if(jQuery('#sparkline8').length > 0 ){	
    $("#sparkline8").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
        ...
        height: "50",
        lineColor: "#dd2f6e",
        fillColor: "rgba(221, 47, 110, .5)",
        minSpotColor: "#dd2f6e",
        maxSpotColor: "#dd2f6e",
        highlightLineColor: "#dd2f6e",
        highlightSpotColor: "#dd2f6e",
...
if(jQuery('#StackedBarChart').length > 0 ){	
    $('#StackedBarChart').sparkline([
        ...
        [4, 1, 2]
            ...
            barWidth: 10,
            barSpacing: 7, 
            stackedBarColor: ['#dd2f6e', '#2bc155', '#ffb800']
        });
}
...
if(jQuery('#sparkline11').length > 0 ){
    ...
    $("#sparkline11").sparkline([24, 61, 51], {
        ...
        height: "100px",
        resize: !0,
        sliceColors: ["rgba(192, 10, 39, .5)", "rgba(0, 0, 128, .5)", "rgba(221, 47, 110, .5)"]
    });
}	
